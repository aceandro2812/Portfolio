...
- After the successful installation of `nodejs` and `npm`, clone the repository into your local system using below command:
  ```bash
   git clone https://github.com/aceandro2812/Portfolio-Website.git
  ```
...
Note here that if you click [my portfolio](https://aceandro2812.github.io), you can see animating the logo at the beginning. I have designed that logo in [`Figma`](https://www.figma.com/) and then animated it using css.
...
- - this is a sort of fork from Ashutosh Hathidara !
